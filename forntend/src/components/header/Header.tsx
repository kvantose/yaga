...
export const Header = () => {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 px-4">
      <header className="mx-auto max-w-5xl flex items-center justify-between px-6 py-3 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
